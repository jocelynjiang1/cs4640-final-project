...
<html lang="en">
<head>
  <!-- Deployed at https://cs4640.cs.virginia.edu/fbj8se/sprint2/ and https://cs4640.cs.virginia.edu/ana2ag/sprint2/ -->
  <meta charset="UTF-8">
  <meta name="author" content="Jennifer Liu">
  <title>Hobby Tracker (Name TBA)</title>
    ...
    <form action="?command=login" class="login-form" method="post">
      ...
      <div class="password-section">
        <input 
          ...
          required
        >
        <p class="password-hint">Minimum of 8 characters</p>
      </div>
